<?php
    ...
    class ProductUtils {
        ...
        public static function getProductInfo($pdo, $product_id) {

            $result = [];

            $availability    = self::getAvailability($pdo, $product_id);
            $media           = self::getMediaPerProduct($pdo, $product_id);
            $paired_products = self::getPairedProducts($pdo, $product_id);
            $features        = self::getFeaturesPerProduct($pdo, $product_id);
